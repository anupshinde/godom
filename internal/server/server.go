...
func stripSourceMapLines(s string) string {
	var out []string
...
func Run(cfg EngineConfig) error {
	...
	// Strip sourceMappingURL lines (autogenerated files, map not served).
	protobufMinJS = stripSourceMapLines(protobufMinJS)
