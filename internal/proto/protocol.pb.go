...
type VDomMessage struct {
	...
	TargetId      string                 `protobuf:"bytes,6,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"` // DOM element ID to render into (multi-component)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *VDomMessage) GetTargetId() string {
	if x != nil {
		return x.TargetId
	}
	return ""
...
const file_internal_proto_protocol_proto_rawDesc = "" +
	...
	"\x04tree\x18\x05 \x01(\fR\x04tree\x12\x1b\n" +
	"\ttarget_id\x18\x06 \x01(\tR\btargetId\"\x83\x02\n" +
	"\bDomPatch\x12\x17\n" +
