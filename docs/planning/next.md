...
| # | Issue | Type |
|---|-------|------|
| 5 | COR-53: Streaming / append-only updates (bypass VDOM) | Feature |
| 6 | COR-77: Showcase example: multi-page dashboard demonstrating all godom capabilities | Example |
| 7 | COR-67: Example: godom with React or a well-known JS library | Example |
